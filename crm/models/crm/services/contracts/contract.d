  ...
  override void initialize(DConfigurationValue configSettings = null) {
    ...
    this
      .addValues([
        ...
        "stateCode": UserIdAttribute, // Shows whether the contract is in draft, invoiced, active, on hold, canceled, or expired. You can edit only the contracts that are in draft status."]),
        "stateCode_display": UserIdAttribute, // 
        "statusCode": UserIdAttribute, // Select the contract's status."]),
        "statusCode_display": UserIdAttribute, // 
