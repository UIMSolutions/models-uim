  ...
  override void initialize(DConfigurationValue configSettings = null) {
    ...
    this
      .addValues([
        ...
        "accountNumber": IntegerAttribute, //Type an ID number or code for the customer to quickly search and identify the customer in system views."]),
        ...
        "stateCode": StringAttribute, // Status of the CustomerProfile"]),
        "stateCode_display": StringAttribute, //
        "statusCode": StringAttribute, // Reason for the status of the CustomerProfile"]),
