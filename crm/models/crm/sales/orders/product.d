  ...
  override void initialize(DConfigurationValue configSettings = null) {
    ...
    this
      .addValues([
        ...
        "lineItemNumber": IntegerAttribute, //Type the line item number for the order product to easily identify the product in the order and make sure it's listed in the correct sequence."]),
        ...
        "requestDeliveryBy": UUIDAttribute, //Enter the delivery date requested by the customer for the order product."]),
        ...
        "sequenceNumber": IntegerAttribute, //Shows the ID of the data that maintains the sequence."]),
