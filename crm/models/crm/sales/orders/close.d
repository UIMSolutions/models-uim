  ...
  override void initialize(DConfigurationValue configSettings = null) {
    ...
    this
      .addData([
        ...
        "stateCode": StringAttribute, // Shows whether the order close activity is open, completed, or canceled. By default, order close activities are completed."]),
        "stateCode_display": StringAttribute, //
        "statusCode": StringAttribute, // Reason for the status of the order close activity."]),
        ...
        "orderNumber": IntegerAttribute, //Order number."]),
