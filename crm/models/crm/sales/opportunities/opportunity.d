  ...
  override void initialize(DConfigurationValue configSettings = null) {
    ...
    this
      .addData([
        ...
        "parentContactId": UUIDAttribute, // Choose a contact to connect this opportunity to, so that the relationship is visible in reports and analytics."]),
        ...
        "SLAId": UUIDAttribute, // aplSLA").descriptions(["en":"Choose the service level agreement (SLA) that you want to apply to the opportunity record."]),
        ...
        "accountId": UUIDAttribute, // Unique identifier of the account with which the opportunity is associated."]),
        "contactId": UUIDAttribute, // Unique identifier of the contact associated with the opportunity."]),
