  ...
  override void initialize(DConfigurationValue configSettings = null) {
    ...
    this
      .addData([
        ...
        "quoteNumber": IntegerAttribute, //Shows the quote number for customer reference and searching capabilities. The number cannot be modified."]),
        "requestDeliveryBy": UUIDAttribute, //Enter the delivery date requested by the customer for all products in the quote."]),
        "revisionNumber": IntegerAttribute, //Shows the version number of the quote for revision history tracking."]),
        ...
        "stateCode": StringAttribute, // Shows whether the quote is draft, active, won, or closed. Only draft quotes can be edited."]),
        "stateCode_display": StringAttribute, //
        "statusCode": StringAttribute, // Select the quote's status."]),
        ...
        "SLAId": UUIDAttribute, // aplSLA").descriptions(["en":"Choose the service level agreement (SLA) that you want to apply to the quote record."]),
        "SLAInvokedId": UUIDAttribute, // Last SLA that was applied to this quote. This field is for internal use only."]),
        "accountId": UUIDAttribute, // Unique identifier of the account with which the quote is associated."]),
        "contactId": UUIDAttribute, // Unique identifier of the contact associated with the quote."]),
