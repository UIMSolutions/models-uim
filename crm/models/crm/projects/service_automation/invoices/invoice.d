  ...
  override void initialize(DConfigurationValue configSettings = null) {
    ...
    this
      .addData([
        ...
        "invoiceNumber": IntegerAttribute, //Shows the identifying number or code of the invoice."]),
        ...
        "stateCode": StringAttribute, // Shows whether the invoice is active, paid, or canceled. Paid and canceled invoices are read-only and can't be edited unless they are reactivated."]),
        "stateCode_display": StringAttribute, //
        "statusCode": StringAttribute, // Select the invoice's status."]),
        ...
        "SLAId": UUIDAttribute, // aplSLA").descriptions(["en":"Choose the service level agreement (SLA) that you want to apply to the invoice record."]),
        ...
        "accountId": UUIDAttribute, // Unique identifier of the account with which the invoice is associated."]),
        "contactId": UUIDAttribute, // Unique identifier of the contact associated with the invoice."]),
