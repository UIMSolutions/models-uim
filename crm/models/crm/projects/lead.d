  ...
  override void initialize(DConfigurationValue configSettings = null) {
    ...
    this
      .addData([
        ...
        "owningBusinessUnitId": UUIDAttribute, //Unique identifier for the business unit that owns the record"]),"owningUserId": UUIDAttribute, //Unique identifier for the user that owns the record."]),
        ...
        "parentContactId": UUIDAttribute, // Choose a contact to connect this lead to, so that the relationship is visible in reports and analytics."]),
        ...
        "stateCode": StringAttribute, // Shows whether the lead is open, qualified, or disqualified. Qualified and disqualified leads are read-only and can't be edited unless they are reactivated."]),
        "stateCode_display": StringAttribute, //"statusCode": StringAttribute, // Select the lead's status."]),
        "statusCode_display": StringAttribute, //"subject": StringAttribute, // Type a subject or descriptive name, such as the expected order, company name, or marketing source list, to identify the lead."]),
        ...
        "SLAId": UUIDAttribute, // aplSLA").descriptions(["en":"Choose the service level agreement (SLA) that you want to apply to the Lead record."]),
        ...
        "accountId": UUIDAttribute, // Unique identifier of the account with which the lead is associated."]),
        "contactId": UUIDAttribute, // Unique identifier of the contact with which the lead is associated."]),
