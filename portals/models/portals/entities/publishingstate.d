module models.portals.entities.publishingstate;

@safe:
import models.portals;

// 
class DPortalPublishingStateEntity : DEntity {
  mixin(EntityThis!("PortalPublishingStateEntity"));
  ...
  override void initialize(Json configSettings = null) {
    ...
    this
      ...
      .addValues([ // individual values
        ...
        "publishingStateId": StringAttribute, //	Shows the entity instance.	
        "stateCode": StringAttribute, //	Status of the Publishing State	
        "stateCode_display": StringAttribute, //		
        "statusCode": StringAttribute, //	Select the publishing state's status.	
        "statusCode_display": StringAttribute, //		
        "name": StringAttribute, //	Type the name of the custom entity.	
        "displayOrder": StringAttribute, //		
        "isDefault": StringAttribute, //		
        "isVisible": StringAttribute, //		
        "websiteId": StringAttribute, //	Unique identifier for Website associated with Publishing State.	
      ])
      .registerPath("portal_publishingstates")      
      .routingPath("/portals/publishingstates");
  }
...
mixin(EntityCalls!("PortalPublishingStateEntity"));